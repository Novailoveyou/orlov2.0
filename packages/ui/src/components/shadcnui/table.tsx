...
function Table({ className, ...props }: React.ComponentProps<'table'>) {
  return (
    <div
      ...
      <table
        data-slot='table'
        className={cn('ui:w-full ui:text-sm ui:caption-bottom', className)}
        {...props}
      />
    </div>
  )
...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
      ...
      className={cn(
        'ui:bg-muted/50 ui:border-t ui:[&>tr]:last:border-b-0 ui:font-medium',
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot='table-row'
      className={cn(
        'ui:data-[state=selected]:bg-muted ui:hover:bg-muted/50 ui:border-b ui:transition-colors',
        className,
      )}
      {...props}
    />
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn('ui:mt-4 ui:text-muted-foreground ui:text-sm', className)}
      {...props}
    />
  )
}
