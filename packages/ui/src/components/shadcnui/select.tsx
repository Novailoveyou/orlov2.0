  ...
  return (
    <SelectPrimitive.Trigger
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className='ui:opacity-50 ui:size-4' />
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn(
        'ui:px-2 ui:py-1.5 ui:text-muted-foreground ui:text-xs',
        className,
      )}
      {...props}
    />
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}>
      <span className='ui:right-2 ui:absolute ui:flex ui:justify-center ui:items-center ui:size-3.5'>
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn(
        'ui:-mx-1 ui:my-1 ui:bg-border ui:h-px ui:pointer-events-none',
        className,
      )}
      {...props}
    />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        'ui:flex ui:justify-center ui:items-center ui:py-1 ui:cursor-default',
        className,
      )}
      {...props}>
