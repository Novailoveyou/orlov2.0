  ...
  return (
    <DrawerPortal data-slot='drawer-portal'>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'ui:group/drawer-content ui:z-50 ui:fixed ui:flex ui:flex-col ui:bg-background ui:h-auto',
        ...
        {...props}>
        <div className='ui:hidden ui:group-data-[vaul-drawer-direction=bottom]/drawer-content:block ui:bg-muted ui:mx-auto ui:mt-4 ui:rounded-full ui:w-[100px] ui:h-2 ui:shrink-0' />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'ui:flex ui:flex-col ui:gap-0.5 ui:md:gap-1.5 ui:p-4 ui:md:text-left ui:group-data-[vaul-drawer-direction=bottom]/drawer-content:text-center ui:group-data-[vaul-drawer-direction=top]/drawer-content:text-center',
        className,
      )}
      {...props}
    />
