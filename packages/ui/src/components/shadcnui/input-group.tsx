...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role='group'
      className={cn(
        'ui:group/input-group ui:relative ui:flex ui:items-center ui:dark:bg-input/30 ui:shadow-xs ui:border ui:border-input ui:rounded-md ui:outline-none ui:w-full ui:transition-[color,box-shadow]',
...
const inputGroupButtonVariants = cva(
  'ui:flex ui:items-center ui:gap-2 ui:shadow-none ui:text-sm',
  {
    variants: {
      size: {
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        'ui:flex-1 ui:bg-transparent ui:dark:bg-transparent ui:shadow-none ui:border-0 ui:rounded-none ui:focus-visible:ring-0',
        className,
      )}
      {...props}
    />
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot='input-group-control'
      className={cn(
        'ui:flex-1 ui:bg-transparent ui:dark:bg-transparent ui:shadow-none ui:py-3 ui:border-0 ui:rounded-none ui:focus-visible:ring-0 ui:resize-none',
        className,
      )}
      {...props}
    />
