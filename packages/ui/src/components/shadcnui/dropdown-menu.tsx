...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        'ui:flex ui:items-center ui:data-[state=open]:bg-accent ui:focus:bg-accent ui:px-2 ui:py-1.5 ui:data-[inset]:pl-8 ui:rounded-sm ui:outline-hidden ui:text-sm ui:data-[state=open]:text-accent-foreground ui:focus:text-accent-foreground ui:cursor-default ui:select-none',
        className,
      )}
      {...props}>
      {children}
