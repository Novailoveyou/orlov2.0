...
export const initStore = <Store extends Record<string, unknown>>() => {
  ...
  */
  ...
  const createStore = <Slices extends ReturnType<typeof createSlice>[]>(
    slices: Slices,
  ) => {
  ...
  return { createSlice, createStore }
}
