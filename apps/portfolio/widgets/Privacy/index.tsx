...
export const Privacy = () => {
  return (
    <Div>
      ...
      обеспечению безопасности персональных данных, предпринимаемые Орлов Илья
      ...
      может получить о посетителях веб-сайта https://orlov.app.
      <br />
      ...
      интернет по сетевому адресу https://orlov.app.
      <br />
      ...
      <br />
      2.10. Пользователь — любой посетитель веб-сайта https://orlov.app.
      <br />
      ...
      <br />
      3.2. Оператор обязан: — предоставлять субъекту персональных данных по его
      ...
      субъектов персональных данных и их законных представителей в соответствии
      с требованиями Закона о персональных данных; — сообщать в уполномоченный
      ...
      настоящей Политике в отношении обработки персональных данных; — принимать
      ...
      порядок ее получения установлен Законом о персональных данных; — требовать
      ...
      меры по защите своих прав; — выдвигать условие предварительного согласия
      при обработке персональных данных в целях продвижения на рынке товаров,
      ...
      имя
      <br />
      Правовые основания: договоры, заключаемые между оператором и субъектом
      персональных данных
      <br />
      ...
      данных Безопасность персональных данных, которые обрабатываются
      ...
      уведомление на адрес электронной почты Оператора contact@orlov.app с
      ...
      электронный адрес Оператора contact@orlov.app с пометкой «Отзыв согласия
      ...
      Оператору с помощью электронной почты contact@orlov.app.
      <br />
      ...
      Интернет по адресу https://orlov.app/politika-konfidentsialnosti.
    </Div>
  )
}
